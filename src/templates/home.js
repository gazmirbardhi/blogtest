                      ...
                      <div className="columns">
                        ...
                        <div className="column is-three-quarters">
                          <section className="section">
                            ...
                            <h2 className="subtitle is-size-4 has-text-white">Product Manager | Engineer with an eye for design</h2>
                          </section>
                          <section className="section is-paddingless-vertical">
                            <div className="tile is-ancestor">
                              <div className="tile is-horizontal is-parent">
                                <a href="/work" className="tile is-child box things-i-do">
                              ...
                              <div className="tile is-horizontal is-parent">
                                <a href="//blog.arpitgoyal.com" className="tile is-child box things-i-do">
                            ...
                            <div>
                              <a href="/resume" target="_blank" rel="noopener noreferrer" className="is-link negative-margin-top has-text-white level is-flex-mobile level-left is-inline-flex">
                                <span className="c">look at my résumé here</span>
                                <svg className="i" height="12px" id="Capa_1" style={{enableBackground: 'new 0 0 80 80'}} version="1.1" viewBox="0 0 80 80" width="12px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                                  <g>
                          ...
                          <section className="section social">
                            <div className="level">
                              <a href="https://medium.com/@arpit_goyal" target="_blank" rel="noopener noreferrer" className="is-link  negative-margin-top has-text-white level is-flex-mobile is-inline-flex level-left">
                                <svg className="i" enableBackground="new -91 49.217 56.693 56.693" id="Layer_1" version="1.1" viewBox="-91 49.217 56.693 56.693" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="32px">
                                ...
                                <span className="c">I've written some articles on Medium</span>
                              </a>
                            </div>
                            <div className="level">
                              <a href="https://twitter.com/_arpitgoyal" target="_blank" rel="noopener noreferrer" className="is-link  negative-margin-top has-text-white level is-flex-mobile is-inline-flex level-left">
                                <svg className="i" enableBackground="new 0 0 56.693 56.693" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693" width="32px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                            ...
                            <div className="level">
                              <a href="https://www.quora.com/profile/Arpit-Goyal-14" target="_blank" rel="noopener noreferrer" className="is-link  negative-margin-top has-text-white is-flex-mobile is-inline-flex level level-left">
                                <svg className="i" version="1.1" viewBox="0 0 24 24" width="32px" xmlns="http://www.w3.org/2000/svg" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" xmlnsXlink="http://www.w3.org/1999/xlink">
                                  <title />
                                  <desc />
                                  <defs />
